# ============================================================================
# Azure Container Apps Deployment Script for Audit Service (PowerShell)
# ============================================================================
...
$DatabaseUrl = "postgresql://pgadmin:${DbPassword}@${PostgresHost}:5432/${DatabaseName}"
...
Write-Host "Audit Service deployed! Dapr App ID: $AppName" -ForegroundColor Green
